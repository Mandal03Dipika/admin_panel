                                ...
                                <div class="card-body">
                                    ...
                                    <div class="direct-chat-messages">
                                        ...
                                        <div class="direct-chat-msg">
                                            ...
                                            <!-- /.direct-chat-infos -->
                                            <img class="direct-chat-img" src="{{asset('images/quiz.jpg')}}"
                                    ...
                                    <div class="direct-chat-contacts">
                                        <ul class="contacts-list">
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img" src="{{asset('images/quiz.jpg')}}"
                                                        alt="User Avatar">
                                                    ...
                                                    <div class="contacts-list-info">
                                                        <span class="contacts-list-name">
                                                            Count Dracula
                                                            <small
                                                                class="float-right contacts-list-date">2/28/2015</small>
                                                        </span>
                                                ...
                                                <a href="#">
                                                    ...
                                                    <div class="contacts-list-info">
                                                        <span class="contacts-list-name">
                                                            Sarah Doe
                                                            <small
                                                                class="float-right contacts-list-date">2/23/2015</small>
                                                        </span>
                                                ...
                                                <a href="#">
                                                    ...
                                                    <div class="contacts-list-info">
                                                        <span class="contacts-list-name">
                                                            Nadia Jolie
                                                            <small
                                                                class="float-right contacts-list-date">2/20/2015</small>
                                                        </span>
                                                ...
                                                <a href="#">
                                                    ...
                                                    <div class="contacts-list-info">
                                                        <span class="contacts-list-name">
                                                            Nora S. Vans
                                                            <small
                                                                class="float-right contacts-list-date">2/10/2015</small>
                                                        </span>
                                                ...
                                                <a href="#">
                                                    ...
                                                    <div class="contacts-list-info">
                                                        <span class="contacts-list-name">
                                                            John K.
                                                            <small
                                                                class="float-right contacts-list-date">1/27/2015</small>
                                                        </span>
                                                ...
                                                <a href="#">
                                                    ...
                                                    <div class="contacts-list-info">
                                                        <span class="contacts-list-name">
                                                            Kenneth M.
                                                            <small
                                                                class="float-right contacts-list-date">1/4/2015</small>
                                                        </span>
                            ...
                            <div class="card">
                                ...
                                <div class="p-0 card-body">
                                    <ul class="clearfix users-list">
                                        <li>
                                            <img src="{{asset('images/quiz.jpg')}}" alt="User Image">
                            ...
                            <ul class="pl-2 pr-2 products-list product-list-in-card">
                                <li class="item">
                                    <div class="product-img">
                                        <img src="{{asset('images/quiz.jpg')}}" alt="Product Image" class="img-size-50">
                                    </div>
